...
class TestRoundTrip(unittest.TestCase):
    ...
    def test_physical_netlist(self):
        phys_netlist = PhysicalNetlist(name='top', part='xc7a50tfgg484-1')
        ...
        phys_netlist.add_site_instance(
            site_name='IOB_X0Y12', site_type='IOB33')
        ...
        phys_netlist.add_site_instance(
            site_name='IOB_X0Y11', site_type='IOB33')
        ...
        phys_netlist.add_site_instance(
            site_name='IOB_X0Y24', site_type='IOB33')
        ...
        phys_netlist.add_site_instance(
            site_name='BUFGCTRL_X0Y0', site_type='BUFG')
        ...
        phys_netlist.add_site_instance(
            site_name='SLICE_X1Y12', site_type='SLICEL')

        i_root = chain_branches((PhysicalBelPin('IOB_X0Y12', 'PAD', 'PAD'),
                                 PhysicalBelPin('IOB_X0Y12', 'INBUF_EN',
                                                'PAD')))
        ...
        i_buf_root = chain_branches(
            ...
            chain_pips('LIOI3_X0Y11', ('LIOI_IBUF0', 'LIOI_I0',
                                       'LIOI_ILOGIC0_D', 'LIOI_ILOGIC0_O',
                                       'IOI_LOGIC_OUTS18_1')) +
        ...
        clk_root = chain_branches((PhysicalBelPin('IOB_X0Y24', 'PAD', 'PAD'),
                                   PhysicalBelPin('IOB_X0Y24', 'INBUF_EN',
                                                  'PAD')))
        phys_netlist.add_physical_net(
            net_name='clk', sources=[clk_root], stubs=[])
        ...
        clk_ibuf_root = chain_branches(
            ...
            chain_pips('LIOI3_X0Y23', ('LIOI_I0', 'LIOI_ILOGIC0_D',
                                       'LIOI_ILOGIC0_O', 'LIOI_I2GCLK_TOP0')) +
        ...
        phys_netlist.add_physical_net(
            net_name='clk', sources=[clk_ibuf_root], stubs=[])
